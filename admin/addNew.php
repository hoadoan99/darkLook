...
<body>
  ...
  <div class="py-5 text-center">
    ...
    <h2 style="color: #424242;">ADD NEW PRODUCTS</h2>
      ...
      <form class="needs-validation" novalidate="">
        <div class="row">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="number" class="form-control" id="price" placeholder="Enter price...." value="" required="">
            <div style="color: #424242;" class="invalid-feedback">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="number" class="form-control" id="quantity" placeholder="Enter quantity...." value="" required="">
            <div style="color: #424242;" class="invalid-feedback">
          ...
          <div class="col-md-6 mb-3">
            ...
            <textarea name="description" id="description" cols="75" > </textarea>
            <div style="color: #424242;" class="invalid-feedback">
