  ...
  <?php
    ...
    ?>
                <div class="panel-body">
                  <div class="row">
                    <div class="col-lg-12">
                      <form id="login-form" action="functions/checklogin.php" method="post">
                        <div class="form-group">
                          <input type="text" name="txtUserName" id="username1" tabindex="1" class="form-control" placeholder="Username" value="">
                        </div>
                        <div class="form-group">
