            ...
            <div class="col-md-4 col-xs-12 contact">
              <div class="location mb_50">
                ...
                <div class="address">Office address
                  <br> 1245,Nguyen Phong Sac
                  <br> Open 7:00AM</div>
                <div class="call mt_10"><i class="fa fa-phone" aria-hidden="true"></i>+0987 654 321</div>
              </div>
              <div class="Career mb_50">
                ...
                <div class="email mt_10"><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:careers@yourdomain.com" target="_top">career@overwatch19999@gmail.com</a></div>
              </div>
              <div class="Hello mb_50">
                ...
                <div class="email mt_10"><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@yourdomailname.com" target="_top">info@overwatch19999@gmail.com</a></div>
              </div>
            </div>
